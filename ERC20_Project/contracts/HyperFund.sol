...
contract MyToken {
    ...
    // Send `_value` tokens to `_to`(recipient) from your account
    function transfer(address _to, uint256 _value) public returns (bool success) {
        _transfer(msg.sender, _to, _value);
        return true;
    }

    // Send `_value` tokens to `_to`(recipient) on behalf of `_from`(sender)
    ...
    */
    ...
    /*
     * Destroy tokens
     * Remove `_value` tokens from the system - irreversible
